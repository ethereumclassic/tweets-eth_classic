...
- For tweets submitted via #ETCtweets, include "This tweet was suggested via the #ETCtweets hashtag. Thanks, @USER!" either in the retweet text, or a follow up message via a thread; see [Threading](#threading).
